...
import MobileWorkMachine_Drill_ManufacturingDataSheet_v0_1 from "$lib/dataproducts/MobileWorkMachine_Drill_ManufacturingDataSheet_v0.1.svelte"
...
export const supportedDataProducts = {
  ...
  "DigitalProductPassport/MobileWorkMachine/Drill/ManufacturingDataSheet_v0.1":
    MobileWorkMachine_Drill_ManufacturingDataSheet_v0_1,
}
